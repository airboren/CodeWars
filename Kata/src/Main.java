...
/*		kata2_JadenCaseStrings jaden = new kata2_JadenCaseStrings();
		...
		System.out.println("test1: "+output+"test");
...
/*	
		...
		for (int i = 0; i < test2.length; i++){ test2[i] = "o x"; }
        
		test2[303] = "lox";
        test2[70] = "Tin + Oxygen";
        test2[220] = "kNoX";

        String[] output2 = Search.wordSearch("ade", test1);
        System.out.println("Test 1: ");
        for (int i=0;i<output2.length;i++){
        	System.out.println("output "+i+"="+output2[i]);
        }
        String[] output1 = Search.wordSearch("ox", test2);
        System.out.println("Test 2:");
        for (int i=0;i<output1.length;i++){
        	System.out.println("output "+i+"="+output1[i]);
        }
        String[] output3 = Search.wordSearch("  ", test1);
